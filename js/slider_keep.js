            ...
            return function(e) {
                ...
                for (var j = 0; result_list.length > j; j++) {
                    ...
                    if (result_list_for_edit[j][6] == 1) {
                        ...
                        status_dict[2] = "寝返り";
                    } else if (result_list_for_edit[j][6] == 3) {
                        status_dict[3] = "起床";
                    } else {
                        status_dict[4] = "就寝";
                    }

                    position_list.push(result_list_for_edit[j][7]);

                    display_list[j] = "<li class=\"slider-item\" data-index=\"j\"><h6 class=\"img-responsive\">" +
                        time_list[j] + "<br>" +
                        status_dict[result_list_for_edit[j][6]] + "<br>" +
                        position_list[j] + "</li>";
                }
...
document.onkeydown = function(event) {
    ...
    if (keyCode == 39 && check_disabled_next_button[0].firstElementChild.attributes.length != 2) {
        console.log(check_disabled_next_button[0].firstElementChild.attributes.length);
        next();
    } else if (keyCode == 37 && check_disabled_prev_button[0].firstElementChild.attributes.length != 2) {
        console.log(check_disabled_prev_button[0].firstElementChild.attributes.length);
        prev();
    }
};